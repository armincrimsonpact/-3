    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="flex justify-center px-4 py-12">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-white text-center mb-6">Artist Login</h1>
          <p className="text-gray-400 text-center mb-10">Sign in to manage your portfolio and clients</p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 bg-black border-gray-700 rounded checkbox-artist"
                />
