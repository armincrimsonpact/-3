    ...
    <div className="min-h-screen bg-bg">
      ...
      <main className="relative z-10 flex justify-center px-4 py-12">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-textSecondary text-center mb-6">Create Artist Account</h1>
          <p className="text-textTertiary text-center mb-10">Join InkCircle to showcase your work and manage clients</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start">
              <input
                ...
                onChange={handleChange}
                className="h-4 w-4 bg-bg border-textTertiary/30 rounded checkbox-artist mt-0.5"
              />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2 focus:ring-offset-cardBg disabled:opacity-70 transition-all duration-200 hover:shadow-lg"
            >
